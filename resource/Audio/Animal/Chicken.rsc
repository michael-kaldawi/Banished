...
{
	bool _looping = false;
	String _wave = "Audio\Animal\Chicken0.wav";
}

SoundBuffer version1
{
	bool _looping = false;
	String _wave = "Audio\Animal\Chicken1.wav";
}

SoundBuffer version2
{
	bool _looping = false;
	String _wave = "Audio\Animal\Chicken2.wav";
}

SoundBuffer version3
{
	bool _looping = false;
	String _wave = "Audio\Animal\Chicken3.wav";
}
