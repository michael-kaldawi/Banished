...
SelectDescription select
{
	...
	String _spriteName = "FruitWalnut";
	StringTable _stringTable = "Dialog/StringTable.rsc:rawMaterial";
	String _stringName = "Walnut";
...
{
	SpriteSheet _spriteSheet = "Dialog/SpriteSheet.rsc";
	String _spriteName = "SeedWalnutSmall";
	StringTable _stringTable = "Dialog/StringTable.rsc:rawMaterial";
	String _stringName = "SeedWalnut";
...
ModelDescription model
{
	...
	[
		{ 
			AnimationGroup _animations = "Models\NaturalResource\FruitTrees\WalnutTreeAnims.rsc";
			GraphicsMesh _mesh [ "Models\NaturalResource\FruitTrees\WalnutTreeMesh.rsc" ] 
		}
	]
...
FruitDescription fruit
{
	...
	ComponentDescription _rawMaterial = "Template\RawMaterialWalnut.rsc";	
}
