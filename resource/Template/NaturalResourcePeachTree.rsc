...
SelectDescription select
{
	...
	String _spriteName = "FruitPeach";
	StringTable _stringTable = "Dialog/StringTable.rsc:rawMaterial";
	String _stringName = "Peach";
...
{
	SpriteSheet _spriteSheet = "Dialog/SpriteSheet.rsc";
	String _spriteName = "SeedPeachSmall";
	StringTable _stringTable = "Dialog/StringTable.rsc:rawMaterial";
	String _stringName = "SeedPeach";
...
ModelDescription model
{
	...
	[
		{ 
			AnimationGroup _animations = "Models\NaturalResource\FruitTrees\PeachTreeAnims.rsc";
			GraphicsMesh _mesh [ "Models\NaturalResource\FruitTrees\PeachTreeMesh.rsc" ] 
		}
	]
...
FruitDescription fruit
{
	...
	ComponentDescription _rawMaterial = "Template\RawMaterialPeach.rsc";	
}
