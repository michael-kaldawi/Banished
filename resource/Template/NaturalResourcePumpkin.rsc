...
ValueDescription value
{
	...
	String _spriteName = "SeedPumpkinSmall";
	StringTable _stringTable = "Dialog/StringTable.rsc:rawMaterial";
	String _stringName = "SeedPumpkin";
...
{
	SpriteSheet _spriteSheet = "Dialog\SpriteSheet.rsc";
	String _spriteName = "CropPumpkin";
	StringTable _stringTable = "Dialog/StringTable.rsc:rawMaterial";
...
ModelDescription model
{
	MeshGroup _meshes
	[
		{ GraphicsMesh _mesh [ "Models\NaturalResource\Crops\PumpkinMesh.rsc" ] }
	]
...
{
	ComponentDescription _rawMaterial = "Template\RawMaterialPumpkin.rsc";
