...
SelectDescription select
{
	...
	String _spriteName = "FruitPecan";
	StringTable _stringTable = "Dialog/StringTable.rsc:rawMaterial";
	String _stringName = "Pecan";
...
{
	SpriteSheet _spriteSheet = "Dialog/SpriteSheet.rsc";
	String _spriteName = "SeedPecanSmall";
	StringTable _stringTable = "Dialog/StringTable.rsc:rawMaterial";
	String _stringName = "SeedPecan";
...
ModelDescription model
{
	...
	[
		{ 
			AnimationGroup _animations = "Models\NaturalResource\FruitTrees\PecanTreeAnims.rsc";
			GraphicsMesh _mesh [ "Models\NaturalResource\FruitTrees\PecanTreeMesh.rsc" ] 
		}
	]
...
FruitDescription fruit
{
	...
	ComponentDescription _rawMaterial = "Template\RawMaterialPecan.rsc";	
}
