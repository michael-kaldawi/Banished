...
{
	SpriteSheet _spriteSheet = "Dialog/SpriteSheet.rsc";
	String _spriteName = "SeedPlumSmall";
	StringTable _stringTable = "Dialog/StringTable.rsc:rawMaterial";
	String _stringName = "SeedPlum";
...
ModelDescription model
{
	...
	[
		{ 
			AnimationGroup _animations = "Models\NaturalResource\FruitTrees\PlumTreeAnims.rsc";
			GraphicsMesh _mesh [ "Models\NaturalResource\FruitTrees\PlumTreeMesh.rsc" ] 
		}
	]
...
FruitDescription fruit
{
	...
	ComponentDescription _rawMaterial = "Template\RawMaterialPlum.rsc";	
}
