...
SelectDescription select
{
	...
	String _spriteName = "FruitApple";
	StringTable _stringTable = "Dialog/StringTable.rsc:rawMaterial";
	String _stringName = "Apple";
...
{
	SpriteSheet _spriteSheet = "Dialog/SpriteSheet.rsc";
	String _spriteName = "SeedAppleSmall";
	StringTable _stringTable = "Dialog/StringTable.rsc:rawMaterial";
	String _stringName = "SeedApple";
...
ModelDescription model
{
	...
	[
		{ 
			AnimationGroup _animations = "Models\NaturalResource\FruitTrees\AppleTreeAnims.rsc";
			GraphicsMesh _mesh [ "Models\NaturalResource\FruitTrees\AppleTreeMesh.rsc" ] 
		}
	]
...
FruitDescription fruit
{
	...
	ComponentDescription _rawMaterial = "Template\RawMaterialApple.rsc";	
}
