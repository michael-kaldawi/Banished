...
ValueDescription value
{
	...
	String _spriteName = "SeedPepperSmall";
	StringTable _stringTable = "Dialog/StringTable.rsc:rawMaterial";
	String _stringName = "SeedPepper";
...
{
	SpriteSheet _spriteSheet = "Dialog\SpriteSheet.rsc";
	String _spriteName = "CropPepper";
	StringTable _stringTable = "Dialog/StringTable.rsc:rawMaterial";
	String _stringName = "Pepper";
...
ModelDescription model
{
	MeshGroup _meshes
	[
		{ GraphicsMesh _mesh [ "Models\NaturalResource\Crops\PepperMesh.rsc" ] }
	]
...
{
	ComponentDescription _rawMaterial = "Template\RawMaterialPepper.rsc";
