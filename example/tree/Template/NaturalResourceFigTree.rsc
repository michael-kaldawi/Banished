...
{
	SpriteSheet _spriteSheet = "UI\FigSpriteSheet.rsc";
	String _spriteName = "SeedFigSmall";
	StringTable _stringTable = "UI/FigStringTable.rsc";
	String _stringName = "SeedFig";
...
ModelDescription model
{
	...
	[
		{ 
			AnimationGroup _animations = "Models\FigTreeAnims.rsc";
			GraphicsMesh _mesh [ "Models\FigTreeMesh.rsc" ] 
		}
	]
...
FruitDescription fruit
{
	...
	ComponentDescription _rawMaterial = "Template\RawMaterialFig.rsc";	
}
